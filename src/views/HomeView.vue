  ...
  <div class="home">
    <div class="feature-card">
      <router-link to="/movie/tt0409591">
        ...
        <div class="detail">
          <h3>Naruto</h3>
          <p>Anime Heroes Naruto Hatake Kakashi Action Figure, Naruto Wave 1 (36903) ... This play figure lets you bring
            the infamous copy ninja home, and it even comes in</p>
        </div>
      </router-link>
    </div>
